...
function showImage(index) {
    ...
    img.src = `https://bafybeih7fwbepz522yr6ozmkonk6vdyjxbqdf37eokdkwx7omxtgiv3zoe.ipfs.flk-ipfs.xyz/images/${index}.png`;
    ...
    overlayPaths.forEach((path, i) => {
        ...
        const overlayUrl = `https://bafybeih7fwbepz522yr6ozmkonk6vdyjxbqdf37eokdkwx7omxtgiv3zoe.ipfs.flk-ipfs.xyz/Overlays/${path.charAt(0).toUpperCase() + path.slice(1)}/${sanitizeFileName(overlayFileName)}`;
